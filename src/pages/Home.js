...
function Home() {
  ...
  const [data, setData] = useState({});
    useEffect(() => {
      axios.get('https://vitus-mockup-backend-da394cb0d2da.herokuapp.com/customers')
        .then(response => {
  ...
  return (
    <div className="Home">
      ...
      <p style={{width:"80%"}}>NOTE: Welcome to the mock banking application! As this is a mock bank, registration and login will not function for security reasons, but <strong> please click the 
